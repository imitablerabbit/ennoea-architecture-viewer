...
*/
export var RegexHighlighter = function(returnClassName) {
...
RegexHighlighter.prototype.findRegexMatches = function(string, regexString, captureGroup, type, precedence) {
    ...
    while (match = reg.exec(string)) {
        ...
        var matchObject = new Match(index + offset, this.returnClassName + " " + type,
...
RegexHighlighter.prototype.insertSyntaxHighlighting = function(regexObject, string, duplicateFunction) {
    ...
    // TODO: Add a method of wrapping the DOM elements in span tags for highlighting without
    // having to set the innerHTML property of the top level element. This should mean we can
    // preserve the cursor position later on.
